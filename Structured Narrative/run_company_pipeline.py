...
def main() -> int:
    ...
    if not args.skip_llm:
        ...
        run_step("Focus 1 dimensions", [PY, f"{sn}/run_dimension_scoring.py", "--ticker", ticker])
        run_step("Focus 2 delta", [PY, f"{sn}/run_delta_scoring.py", "--ticker", ticker])
        run_step("Focus 3 surprise", [PY, f"{sn}/run_surprise_scoring.py", "--ticker", ticker])
